...
# 六、易错点汇总
# ============================================================
# 1. 综合项目 = 串联所有章节：靶点→化合物库→虚拟筛选→候选
# 2. 项目要【可交付】：有输入、有流程、有输出、有说明
# 3. 项目记录要完整：背景、方法、结果、局限
# 4. 计算模拟的结果要标注"待湿实验验证"，别夸大
# 5. 如果做毕业课题：虚拟筛选 + 湿实验验证是完整闭环
# 6. 这是你四年学习成果的集大成项目
...
#
# 【中等】
# 4. 规划一个"靶点到候选分子"的项目大纲。
# 5. 写项目记录（背景/方法/结果/局限）。
# 6. 说明湿实验验证在项目里的作用。
#
# 【挑战】
# 7. 把虚拟筛选项目整理成完整的科研报告。
# 8. 解释为什么"虚拟+湿实验"闭环更可信。
